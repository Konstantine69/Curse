    ...
    public class ConstructionObjectsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var constructionObject = await _context.ConstructionObjects
                ...
                .Include(c => c.ObjectWorks) // Добавляем связанные работы
                    .ThenInclude(ow => ow.WorkType) // Добавляем тип работы
                .Include(c => c.ObjectMaterials) // Добавляем связанные материалы
                    .ThenInclude(om => om.Material) // Добавляем материалы
