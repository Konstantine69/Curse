...
namespace ProdajnikWeb.Controllers
{
    public class ObjectWorksController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var objectWork = await _context.ObjectWork
                .Include(o => o.Object)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var objectWork = await _context.ObjectWork.FindAsync(id);
            if (objectWork == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (objectWork != null)
            {
                _context.ObjectWork.Remove(objectWork);
            }
        ...
        {
            return _context.ObjectWork.Any(e => e.ObjectWorkId == id);
        }
    }
}
